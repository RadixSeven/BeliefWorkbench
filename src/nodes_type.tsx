...
export type PrimitiveActualType = boolean | number | string | PrimitiveActualType[];
...
export type Node = DistributionNode | FunctionNode | ConstantNode | VisualizationNode;
